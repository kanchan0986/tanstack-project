...
import { useDeliveredProjectListQueries, useProjectListQuery } from '../../services/queries';
...
export default function DeliveredProjectList() {
  ...
  const deliveredProjectListQuery = projectListQuery.data?.filter(project => project.state === true)
